...
def caller(history: str, scam_context: str, responses: int) -> str:
    context = f"""You are a person on a call and you are the caller and you are actually a scammer and the context of your scam is {scam_context} the call history
                ...
                you only have {responses} left  give responses in json the response should look like this "message":"response here" if you don't know the name of the other person ask invent the necessary details the response should not contain any unorganic substance Do the marking like this only scammer and receiver as given in the original text No utterance etc do like this scammer : Hanji hello and receiver : ji kon bolre h like a dialogue"""
